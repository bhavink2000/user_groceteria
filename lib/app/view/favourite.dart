  ...
  Widget build(BuildContext context) {
    return GetBuilder<FavouriteController>(
      builder: (value) {
        return Scaffold(
          appBar: AppBar(
            title: Text('Your Favourite'.tr, style: ThemeProvider.titleStyle),
          ...
          children: [
                                ...
                                children: [
                                  Expanded(
                                    child: product.discount > 0
                                        ? Row(
                                            children: [
                                              Get.find<FavouriteController>().currencySide == 'left'
                                                  ? Text('${Get.find<FavouriteController>().currencySymbol}${product.originalPrice}',
                                                      style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough))
                                                  : Text('${product.originalPrice}${Get.find<FavouriteController>().currencySymbol}',
                                                      style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                              Get.find<FavouriteController>().currencySide == 'left'
                                                  ? Text('${Get.find<FavouriteController>().currencySymbol}${product.sellPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                  : Text('${product.sellPrice}${Get.find<FavouriteController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium')),
                                            ],
                                          )
                                        : Row(
                                            children: [
                                              Get.find<FavouriteController>().currencySide == 'left'
                                                  ? Text('${Get.find<FavouriteController>().currencySymbol}${product.originalPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                  : Text('${product.originalPrice}${Get.find<FavouriteController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                            ],
                                          ),
                                  ),
                                ],
                                            ...
                                            itemBuilder: (BuildContext context, int index) {
                                              ...
                                              return ListTile(
                                                    ...
                                                    ? Get.find<FavouriteController>().currencySide == 'left'
                                                        ? Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(Get.find<FavouriteController>().currencySymbol + product.variations![0].items![index].price.toString(),
                                                                  style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                              Text(
                                                                Get.find<FavouriteController>().currencySymbol + product.variations![0].items![index].discount.toString(),
                                                        ...
                                                        : Row(
                                                            ...
                                                            children: [
                                                              Text(product.variations?[0].items?[index].title + ' - ', textAlign: TextAlign.start, style: const TextStyle(fontSize: 10)),
                                                              Text(product.variations![0].items![index].price.toString() + Get.find<FavouriteController>().currencySymbol,
                                                                  style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                              Text(
                                                                product.variations![0].items![index].discount.toString() + Get.find<FavouriteController>().currencySymbol,
                                                                style: const TextStyle(fontFamily: 'bold', fontSize: 10),
                                                              )
                                                            ],
                                                          )
                                                            ...
                                                            children: [
                                                              Text(
                                                                  product.variations?[0].items?[index].title +
                                                                      ' - ' +
                                                                      Get.find<FavouriteController>().currencySymbol +
                                                ...
                                                leading: Radio(
                                                  ...
                                                  onChanged: (e) {
                                                    Get.find<FavouriteController>().updateAddons(productIndex, e as int);
                                ...
                                ? Get.find<FavouriteController>().currencySide == 'left'
                                    ? Row(
                                        ...
                                        children: [
                                          ...
                                          Text(Get.find<FavouriteController>().currencySymbol + product.variations![0].items![product.variant].price.toString(),
                                              style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                          Text(
                                            Get.find<FavouriteController>().currencySymbol + product.variations![0].items![product.variant].discount.toString(),
                                            style: const TextStyle(fontFamily: 'bold', fontSize: 10),
                                          )
                                        ],
                                      )
                                    : Row(
                                        ...
                                        children: [
                                          Text(product.variations?[0].items?[product.variant].title + ' - ', textAlign: TextAlign.center, style: const TextStyle(fontSize: 10)),
                                          Text(product.variations![0].items![product.variant].price.toString() + Get.find<FavouriteController>().currencySymbol,
                                              style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                          Text(
                                            product.variations![0].items![product.variant].discount.toString() + Get.find<FavouriteController>().currencySymbol,
                                            style: const TextStyle(fontFamily: 'bold', fontSize: 10),
                                          )
                                        ],
                                      )
            ...
            (product.quantity == 0)
                ? Container(
                    ...
                    child: TextButton(
                      onPressed: () => Get.find<FavouriteController>().addPopular(productIndex),
                ...
                : Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () => Get.find<FavouriteController>().updatePopularProducts(productIndex, 'remove'),
                        ...
                        InkWell(
                          onTap: () => Get.find<FavouriteController>().updatePopularProducts(productIndex, 'add'),
