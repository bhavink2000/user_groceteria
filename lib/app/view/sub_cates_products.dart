...
class SubCatesProductScreen extends StatefulWidget {
  const SubCatesProductScreen({Key? key}) : super(key: key);

  @override
  State<SubCatesProductScreen> createState() => _SubCatesProductScreenState();
}

class _SubCatesProductScreenState extends State<SubCatesProductScreen> {
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels == _scrollController.position.maxScrollExtent) {
        Get.find<SubCatesProductsController>().increment();
      }
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SubCatesProductsController>(
      builder: (value) {
        return Scaffold(
          appBar: AppBar(
            title: Text(value.subCateName.toString(), style: ThemeProvider.titleStyle),
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(value.products.length.toString() + ' Items'.tr, style: const TextStyle(fontSize: 10, fontFamily: 'medium', color: Colors.grey)),
                        ),
                        Row(
                          children: [
                            IconButton(
                          ...
                          : Column(
                              children: [
                                ListView(
                                  ...
                                  physics: const ScrollPhysics(),
                                  children: List.generate(value.products.length, (index) {
                                    return _buildCartProduct(value.products[index], index);
                                  }),
                                )
                              ],
                            ),
                      if (value.loadMore == true) const Center(child: CircularProgressIndicator())
                    ],
                  ),
                ),
        );
            ...
            children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: product.discount > 0
                                          ? Row(
                                              children: [
                                                Get.find<SubCatesProductsController>().currencySide == 'left'
                                                    ? Text('${Get.find<SubCatesProductsController>().currencySymbol}${product.originalPrice}',
                                                        style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough))
                                                    : Text('${product.originalPrice}${Get.find<SubCatesProductsController>().currencySymbol}',
                                                        style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                Get.find<SubCatesProductsController>().currencySide == 'left'
                                                    ? Text('${Get.find<SubCatesProductsController>().currencySymbol}${product.sellPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                    : Text('${product.sellPrice}${Get.find<SubCatesProductsController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium')),
                                              ],
                                            )
                                          : Row(
                                              children: [
                                              ...
                                              itemBuilder: (BuildContext context, int index) {
                                                ...
                                                return ListTile(
                                                      ...
                                                      ? Get.find<SubCatesProductsController>().currencySide == 'left'
                                                          ? Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(Get.find<SubCatesProductsController>().currencySymbol + product.variations![0].items![index].price.toString(),
                                                                    style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                                Text(Get.find<SubCatesProductsController>().currencySymbol + product.variations![0].items![index].discount.toString(),
                                                          ...
                                                          : Row(
                                                              ...
                                                              children: [
                                                                Text(product.variations?[0].items?[index].title + ' - ', textAlign: TextAlign.start, style: const TextStyle(fontSize: 10)),
                                                                Text(product.variations![0].items![index].price.toString() + Get.find<SubCatesProductsController>().currencySymbol,
                                                                    style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                                Text(product.variations![0].items![index].discount.toString() + Get.find<SubCatesProductsController>().currencySymbol,
                                                                    style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                                              ],
                                                            )
                                                      : Get.find<SubCatesProductsController>().currencySide == 'left'
                                                              ...
                                                              children: [
                                                                Text(
                                                                  product.variations?[0].items?[index].title +
                                                                      ' - ' +
                                                                      Get.find<SubCatesProductsController>().currencySymbol +
                                                  ...
                                                  leading: Radio(
                                                    ...
                                                    onChanged: (e) {
                                                      Get.find<SubCatesProductsController>().updateAddons(productIndex, e as int);
                                  ...
                                  ? Get.find<SubCatesProductsController>().currencySide == 'left'
                                      ? Row(
                                          ...
                                          children: [
                                            ...
                                            Text(Get.find<SubCatesProductsController>().currencySymbol + product.variations![0].items![product.variant].price.toString(),
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(Get.find<SubCatesProductsController>().currencySymbol + product.variations![0].items![product.variant].discount.toString(),
                                                style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                      : Row(
                                          ...
                                          children: [
                                            Text(product.variations?[0].items?[product.variant].title + ' - ', textAlign: TextAlign.center, style: const TextStyle(fontSize: 10)),
                                            Text(product.variations![0].items![product.variant].price.toString() + Get.find<SubCatesProductsController>().currencySymbol,
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(product.variations![0].items![product.variant].discount.toString() + Get.find<SubCatesProductsController>().currencySymbol,
                                                style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                  : Get.find<SubCatesProductsController>().currencySide == 'left'
              ...
              (product.quantity == 0)
                  ? Container(
                      ...
                      child: TextButton(
                        onPressed: () => Get.find<SubCatesProductsController>().addPopular(productIndex),
                  ...
                  : Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () => Get.find<SubCatesProductsController>().updatePopularProducts(productIndex, 'remove'),
                          ...
                          InkWell(
                            onTap: () => Get.find<SubCatesProductsController>().updatePopularProducts(productIndex, 'add'),
                            ...
                            Expanded(
                              child: product.discount > 0
                                  ...
                                  : Row(
                                      children: [
                                        Get.find<SubCatesProductsController>().currencySide == 'left'
                                            ? Text('${Get.find<SubCatesProductsController>().currencySymbol}${product.originalPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                            : Text('${product.originalPrice}${Get.find<SubCatesProductsController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                      ],
                                    ),
                            ),
                          ],
