                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Text(value.storeName, style: const TextStyle(fontSize: 14, fontFamily: 'bold')),
                                            ...
                                            Row(
                                              children: <Widget>[
                                                ...
                                                value.currencySide == 'left'
                                                    ? Text(value.currencySymbol + value.storeAmount.toString(), style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor))
                                                    : Text(value.storeAmount.toString() + value.currencySymbol)
                                              ],
                                            ),
                                            const SizedBox(height: 5),
                                            Row(
                                              children: <Widget>[
                                                ...
                                                const SizedBox(width: 5),
                                                Text(value.payMethod == 'cod' ? 'COD'.tr : 'PAID'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor))
                                              ],
                                            ),
                                            const SizedBox(height: 5),
                                            Row(children: <Widget>[const Icon(Icons.call, size: 17), const SizedBox(width: 5), Text(value.storeMobile.toString())]),
                                            const SizedBox(height: 5),
                                            Row(
                                              children: <Widget>[
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Text(value.storeAddress, maxLines: 3, softWrap: false, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 10)),
                                                ),
                                              ],
                                            ),
                                          ],
                      ...
                      value.googleMapsType == 'driver'
                          ? Padding(
                              ...
                              child: Container(
                                ...
                                width: double.infinity,
                                decoration: BoxDecoration(border: Border(bottom: BorderSide(width: 1, color: ThemeProvider.greyColor.shade300))),
                                child: Text('Driver Information'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold')),
                              ),
                            )
                          : const SizedBox(),
                      value.googleMapsType == 'driver'
                          ? InkWell(
                              onTap: () => value.openDriverModal(),
                              child: Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 16),
                                child: Container(
                                  padding: const EdgeInsets.symmetric(vertical: 16),
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: <Widget>[
                                            Text(value.driverName, style: const TextStyle(fontSize: 14, fontFamily: 'bold')),
                                            const SizedBox(height: 5),
                                            Row(
                                              children: <Widget>[
                                                const Icon(Icons.payment_outlined, size: 17, color: ThemeProvider.appColor),
                                                ...
                                                const SizedBox(width: 5),
                                                value.currencySide == 'left'
                                                    ? Text(value.currencySymbol + value.driverAmountPay.toString(), style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor))
                                                    : Text(value.driverAmountPay.toString() + value.currencySymbol)
                                              ],
                                            ),
                                            const SizedBox(height: 5),
                                            Row(
                                            ...
                                            const SizedBox(height: 5),
                                            Row(
                                              children: <Widget>[const Icon(Icons.call, size: 17), const SizedBox(width: 5), Text(value.driverMobile.toString())],
                                            ),
                                          ],
                                        ),
                                      ),
