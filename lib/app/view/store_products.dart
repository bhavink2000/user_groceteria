  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels == _scrollController.position.maxScrollExtent) {
        Get.find<StoreProductsController>().increment();
      }
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<StoreProductsController>(
      builder: (value) {
        return Scaffold(
          appBar: AppBar(
            title: Text(value.storeName.toString(), style: ThemeProvider.titleStyle),
            backgroundColor: ThemeProvider.appColor,
            automaticallyImplyLeading: true,
            elevation: 0.0,
            centerTitle: false,
            actions: <Widget>[
              IconButton(onPressed: () => Get.toNamed(AppRouter.getSearchRoute()), icon: const Icon(Icons.search)),
              IconButton(onPressed: () => value.onStoreChat(), icon: const Icon(Icons.wechat_outlined))
            ],
            ...
            children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: product.discount > 0
                                          ? Row(
                                              children: [
                                                Get.find<StoreProductsController>().currencySide == 'left'
                                                    ? Text('${Get.find<StoreProductsController>().currencySymbol}${product.originalPrice}',
                                                        style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough))
                                                    : Text('${product.originalPrice}${Get.find<StoreProductsController>().currencySymbol}',
                                                        style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                Get.find<StoreProductsController>().currencySide == 'left'
                                                    ? Text('${Get.find<StoreProductsController>().currencySymbol}${product.sellPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                    : Text('${product.sellPrice}${Get.find<StoreProductsController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium')),
                                              ],
                                            )
                                          : Row(
                                              children: [
                                                Get.find<StoreProductsController>().currencySide == 'left'
                                                    ? Text('${Get.find<StoreProductsController>().currencySymbol}${product.originalPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                    : Text('${product.originalPrice}${Get.find<StoreProductsController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                              ],
                                            ),
                                    ),
                                  ],
                                              ...
                                              itemBuilder: (BuildContext context, int index) {
                                                ...
                                                return ListTile(
                                                      ...
                                                      ? Get.find<StoreProductsController>().currencySide == 'left'
                                                          ? Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(Get.find<StoreProductsController>().currencySymbol + product.variations![0].items![index].price.toString(),
                                                                    style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                                Text(Get.find<StoreProductsController>().currencySymbol + product.variations![0].items![index].discount.toString(),
                                                          ...
                                                          : Row(
                                                              ...
                                                              children: [
                                                                Text(product.variations?[0].items?[index].title + ' - ', textAlign: TextAlign.start, style: const TextStyle(fontSize: 10)),
                                                                Text(product.variations![0].items![index].price.toString() + Get.find<StoreProductsController>().currencySymbol,
                                                                    style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                                Text(product.variations![0].items![index].discount.toString() + Get.find<StoreProductsController>().currencySymbol,
                                                                    style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                                              ],
                                                            )
                                                      : Get.find<StoreProductsController>().currencySide == 'left'
                                                              ...
                                                              children: [
                                                                Text(
                                                                  product.variations?[0].items?[index].title +
                                                                      ' - ' +
                                                                      Get.find<StoreProductsController>().currencySymbol +
                                                  ...
                                                  leading: Radio(
                                                    ...
                                                    onChanged: (e) {
                                                      Get.find<StoreProductsController>().updateAddons(productIndex, e as int);
                                  ...
                                  ? Get.find<StoreProductsController>().currencySide == 'left'
                                      ? Row(
                                          ...
                                          children: [
                                            ...
                                            Text(Get.find<StoreProductsController>().currencySymbol + product.variations![0].items![product.variant].price.toString(),
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(Get.find<StoreProductsController>().currencySymbol + product.variations![0].items![product.variant].discount.toString(),
                                                style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                      : Row(
                                          ...
                                          children: [
                                            Text(product.variations?[0].items?[product.variant].title + ' - ', textAlign: TextAlign.center, style: const TextStyle(fontSize: 10)),
                                            Text(product.variations![0].items![product.variant].price.toString() + Get.find<StoreProductsController>().currencySymbol,
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(product.variations![0].items![product.variant].discount.toString() + Get.find<StoreProductsController>().currencySymbol,
                                                style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                  : Get.find<StoreProductsController>().currencySide == 'left'
              ...
              (product.quantity == 0)
                  ? Container(
                      ...
                      child: TextButton(
                        onPressed: () => Get.find<StoreProductsController>().addPopular(productIndex),
                  ...
                  : Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () => Get.find<StoreProductsController>().updatePopularProducts(productIndex, 'remove'),
                          ...
                          InkWell(
                            onTap: () => Get.find<StoreProductsController>().updatePopularProducts(productIndex, 'add'),
