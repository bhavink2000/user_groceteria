...
class TopPickedScreen extends StatefulWidget {
  const TopPickedScreen({Key? key}) : super(key: key);

  @override
  State<TopPickedScreen> createState() => _TopPickedScreenState();
}

class _TopPickedScreenState extends State<TopPickedScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TopPickedController>(
      builder: (value) {
        return Scaffold(
          appBar: AppBar(
            title: Text('Top Picked'.tr, style: ThemeProvider.titleStyle),
            ...
            children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: product.discount > 0
                                          ? Row(
                                              children: [
                                                Get.find<TopPickedController>().currencySide == 'left'
                                                    ? Text('${Get.find<TopPickedController>().currencySymbol}${product.originalPrice}',
                                                        style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough))
                                                    : Text('${product.originalPrice}${Get.find<TopPickedController>().currencySymbol}',
                                                        style: const TextStyle(fontSize: 14, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                Get.find<TopPickedController>().currencySide == 'left'
                                                    ? Text('${Get.find<TopPickedController>().currencySymbol}${product.sellPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                    : Text('${product.sellPrice}${Get.find<TopPickedController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium')),
                                              ],
                                            )
                                          : Row(
                                              children: [
                                                Get.find<TopPickedController>().currencySide == 'left'
                                                    ? Text('${Get.find<TopPickedController>().currencySymbol}${product.originalPrice}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                                    : Text('${product.originalPrice}${Get.find<TopPickedController>().currencySymbol}', style: const TextStyle(fontSize: 16, fontFamily: 'medium'))
                                              ],
                                            ),
                                    ),
                                  ],
                                              ...
                                              itemBuilder: (BuildContext context, int index) {
                                                ...
                                                return ListTile(
                                                      ...
                                                      ? Get.find<TopPickedController>().currencySide == 'left'
                                                          ? Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(Get.find<TopPickedController>().currencySymbol + product.variations![0].items![index].price.toString(),
                                                                    style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                                Text(Get.find<TopPickedController>().currencySymbol + product.variations![0].items![index].discount.toString(),
                                                          ...
                                                          : Row(
                                                              ...
                                                              children: [
                                                                Text(product.variations?[0].items?[index].title + ' - ', textAlign: TextAlign.start, style: const TextStyle(fontSize: 10)),
                                                                Text(product.variations![0].items![index].price.toString() + Get.find<TopPickedController>().currencySymbol,
                                                                    style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                                                Text(product.variations![0].items![index].discount.toString() + Get.find<TopPickedController>().currencySymbol,
                                                                    style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                                              ],
                                                            )
                                                      : Get.find<TopPickedController>().currencySide == 'left'
                                                              ...
                                                              children: [
                                                                Text(
                                                                  product.variations?[0].items?[index].title +
                                                                      ' - ' +
                                                                      Get.find<TopPickedController>().currencySymbol +
                                                  ...
                                                  leading: Radio(
                                                    ...
                                                    onChanged: (e) {
                                                      Get.find<TopPickedController>().updateAddons(productIndex, e as int);
                                  ...
                                  ? Get.find<TopPickedController>().currencySide == 'left'
                                      ? Row(
                                          ...
                                          children: [
                                            ...
                                            Text(Get.find<TopPickedController>().currencySymbol + product.variations![0].items![product.variant].price.toString(),
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(Get.find<TopPickedController>().currencySymbol + product.variations![0].items![product.variant].discount.toString(),
                                                style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                      : Row(
                                          ...
                                          children: [
                                            Text(product.variations?[0].items?[product.variant].title + ' - ', textAlign: TextAlign.center, style: const TextStyle(fontSize: 10)),
                                            Text(product.variations![0].items![product.variant].price.toString() + Get.find<TopPickedController>().currencySymbol,
                                                style: const TextStyle(fontSize: 10, fontFamily: 'regular', decoration: TextDecoration.lineThrough)),
                                            Text(product.variations![0].items![product.variant].discount.toString() + Get.find<TopPickedController>().currencySymbol,
                                                style: const TextStyle(fontFamily: 'bold', fontSize: 10))
                                          ],
                                        )
                                  : Get.find<TopPickedController>().currencySide == 'left'
              ...
              (product.quantity == 0)
                  ? Container(
                      ...
                      child: TextButton(
                        onPressed: () => Get.find<TopPickedController>().addPopular(productIndex),
                  ...
                  : Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () => Get.find<TopPickedController>().updatePopularProducts(productIndex, 'remove'),
                          ...
                          InkWell(
                            onTap: () => Get.find<TopPickedController>().updatePopularProducts(productIndex, 'add'),
