...
class TopPickedController extends GetxController implements GetxService {
  final TopPickedParser parser;
  ...
  TopPickedController({required this.parser});
  ...
  Future<void> getTopRated() async {
    Response response = await parser.getTopRated();
    apiCalled = true;
    if (response.statusCode == 200) {
      Map<String, dynamic> myMap = Map<String, dynamic>.from(response.body);
      dynamic body = myMap["topProducts"];
      _topProducts = [];
      body.forEach((data) {
