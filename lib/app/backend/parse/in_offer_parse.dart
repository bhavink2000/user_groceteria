...
class InOfferParser {
  ...
  InOfferParser({required this.sharedPreferencesManager, required this.apiService});

  Future<Response> getTopRated() async {
    return await apiService.postPublic(AppConstants.getInOffers, {'storeIds': sharedPreferencesManager.getString('storeIds')});
  }
